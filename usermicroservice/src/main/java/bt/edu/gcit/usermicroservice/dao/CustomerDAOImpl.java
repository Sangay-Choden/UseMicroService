...
Customer.class);
 ...
 if (customer != null) {
    ...
    if (country == null) {
    // If the country is not found in the database, throw an exception orhandle this case as appropriate
    throw new RuntimeException("Country not found");
    }
    customer.setCountry(country);
    System.out.println("Country: " + country.getName());
    } else {
    // If the country is null, throw an exception or handle this case asappropriate
